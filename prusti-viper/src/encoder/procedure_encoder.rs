...
impl<'p, 'v: 'p, 'tcx: 'v> ProcedureEncoder<'p, 'v, 'tcx> {
    ...
    fn encode_postcondition_expr(
        ...
        for place in contract.borrow_infos.returned_inputs() {
            let mutability = contract.borrow_infos.mutability[place];
            debug!(
        ...
        let magic_wands = self.encode_postcondition_magic_wand(
